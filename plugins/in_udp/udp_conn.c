...
int udp_conn_event(void *data)
{
    ...
    struct udp_conn *conn = data;
    struct flb_in_udp_config *ctx = conn->ctx;
...
struct udp_conn *udp_conn_add(int fd, struct flb_in_udp_config *ctx)
{
    int ret;
